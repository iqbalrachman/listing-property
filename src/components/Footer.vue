...
const socials = computed(() => [
  {
    ...
    path: 'M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5zm5 5.5a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9zm5.2-1.7a1 1 0 1 1 0 2 1 1 0 0 1 0-2z'
  },
  {
    key: 'facebook',
    url: props.settings?.facebook,
    path: 'M14 9h3V6h-3c-2 0-3.5 1.5-3.5 3.5V11H8v3h2.5v7h3v-7H16l.5-3h-3V9.7c0-.5.3-.7.8-.7z'
  },
  {
    key: 'tiktok',
    url: props.settings?.tiktok,
    path: 'M14 3v10.5a2.5 2.5 0 1 1-2-2.45V9a4.5 4.5 0 1 0 4 4.47V8.2a6 6 0 0 0 3.5 1.3V7.4A4 4 0 0 1 16 3h-2z'
  },
  {
    key: 'linkedin',
    url: props.settings?.linkedin,
    path: 'M4.5 3.5A1.5 1.5 0 1 0 4.5 6.5 1.5 1.5 0 0 0 4.5 3.5zM3 8h3v13H3zM9 8h3v1.8c.5-.9 1.7-1.8 3.3-1.8 3 0 4.7 2 4.7 5.7V21h-3v-6.4c0-1.7-.6-2.9-2.2-2.9-1.2 0-1.9.8-2.2 1.6-.1.3-.1.6-.1 1V21H9z'
  },
  {
    key: 'twitter',
    url: props.settings?.twitter,
    path: 'M3 3l7.5 9.5L3.3 21H6l5.8-6.8L16.5 21H21l-8-9.9L20.4 3H18l-5.3 6.3L8 3H3z'
  }
])
    ...
    <div class="container footer-inner">
      <div class="footer-about">
        ...
        <div class="social-row" v-if="activeSocials.length">
            ...
            class="social-icon" :aria-label="s.key"
          >
